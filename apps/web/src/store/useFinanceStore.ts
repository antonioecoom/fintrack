  ...
  return {
    ...
    fetchUserData: async () => {
      ...
      try {
        ...
        set({ error: err.message || 'Error al cargar datos del usuario' });
      } finally {
        set({ loading: false });
      }
    },
    ...
    deleteAccount: async (id) => {
      ...
      try {
        ...
        await get().fetchAccounts();
        // Since deleting account cascades deletes to transactions, re-fetch transactions
        await get().fetchTransactions();
      } catch (err: any) {
    ...
    createTransaction: async (transaction) => {
      ...
      try {
        ...
        // Re-fetch transactions and accounts (due to trigger balance updates)
        await get().fetchTransactions();
        await get().fetchAccounts();
      } catch (err: any) {
    ...
    updateTransaction: async (id, updates) => {
      ...
      try {
        ...
        set({ error: err.message || 'Error al actualizar transacción' });
        throw err;
      } finally {
        set({ loading: false });
      }
